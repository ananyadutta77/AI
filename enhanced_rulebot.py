...
weather=["it is monsoon",'it is not monsoon']
...
def climate():
    print(Fore.GREEN+"Travel bot:you can refer to my specific weather app for this!")
def news():
    print(Fore.GREEN+"Travel bot:you can refer to my specific news app for this!")
def times():
    print(Fore.GREEN+"Travel bot:you can refer to my specific local time app for this!")        
...
def show_help():
    ...
    print(Fore.GREEN+"weather info:(say climate)")
    print(Fore.GREEN+"news:(say news)")
    print(Fore.GREEN+"local time:(say time)")
